...
@dataclass
class Seq2SeqMultipleLMOutput(ModelOutput):
    """
    Base class for sequence-to-sequence language models outputs.
    ...
    past_key_values: Optional[dict[Tuple[Tuple[torch.FloatTensor]]]] = None
    decoders_hidden_states: Optional[dict[Tuple[torch.FloatTensor]]] = None
    decoders_attentions: Optional[dict[Tuple[torch.FloatTensor]]] = None
    cross_attentions: Optional[dict[Tuple[torch.FloatTensor]]] = None
    encoder_last_hidden_state: Optional[torch.FloatTensor] = None
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
