...
def convert_wav2vec2_checkpoint(
    ...
    hf_wav2vec = SpeechEncoderMultipleDecodersModel(encoder=hf_encoder, decoder=hf_decoder)
    ...
    hf_wav2vec.config = SpeechEncoderMultipleDecodersConfig.from_dict(config)
